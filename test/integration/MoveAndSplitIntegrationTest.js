...
describe('Offline Support move and split', () => {
	...
	it('should converge after 1 replica moves a block and the other splits the block', () => {
		...
		crdt1.insertContentInBlock('aaaa', 0, blockId1);
		crdt2.insertContentInBlock('bbbb', 0, blockId2);
		crdt1.insertContentInBlock('cccc', 0, blockId3);
